...
const usuariosComMais1Ano = usuarios.map((usuario) => {
    return Object.assign(Object.assign({}, usuario), { idade: usuario.idade + 1 });
});
...
console.log(`Primeiro usuário com nome João: ${primeiroComNomeJoao === null || primeiroComNomeJoao === void 0 ? void 0 : primeiroComNomeJoao.id}`);
console.log(`Primeiro usuário inativo: ${primeiroUsuarioInativo === null || primeiroUsuarioInativo === void 0 ? void 0 : primeiroUsuarioInativo.nome}`);
